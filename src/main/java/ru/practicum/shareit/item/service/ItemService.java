...
public interface ItemService {
    ...
    Page<ItemOwnerDto> getAllItemsByOwnerId(Long ownerId, Integer from, Integer size);

    Page<ItemOwnerDto> getAvailableItemsByName(String name, Integer from, Integer size);
