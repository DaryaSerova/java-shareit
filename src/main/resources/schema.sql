...
CREATE TABLE IF NOT EXISTS REQUEST_T (
	...
	CONSTRAINT REQUEST_T_FK FOREIGN KEY (REQUESTOR_ID) REFERENCES USER_T(ID)
);
CREATE TABLE IF NOT EXISTS ITEM_T (
	...
	CONSTRAINT ITEM_T_FK_1 FOREIGN KEY (REQUEST_ID) REFERENCES REQUEST_T(ID)
);
...
CREATE TABLE IF NOT EXISTS BOOKING_T (
	...
	CONSTRAINT BOOKING_T_FK FOREIGN KEY (ITEM_ID) REFERENCES ITEM_T(ID),
	CONSTRAINT BOOKING_T_FK_1 FOREIGN KEY (BOOKER_ID) REFERENCES USER_T(ID)
);
...
CREATE TABLE IF NOT EXISTS COMMENT_T (
	...
	CONSTRAINT COMMENT_T_FK FOREIGN KEY (ITEM_ID) REFERENCES ITEM_T(ID),
	CONSTRAINT COMMENT_T_FK_1 FOREIGN KEY (AUTHOR_ID) REFERENCES USER_T(ID)
);